...
import org.junit.runner.RunWith;// Cucumber always need support from junit
...
public class RunnerClass {// we are not going to write anything inside the class we are going to
    // write out of the class
